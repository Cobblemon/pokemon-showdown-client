...
export const Dex = new class implements ModdedDex {
	...
	getSpriteData(pokemon: Pokemon | Species | string, isFront: boolean, options: {
		...
		const cobblemonSprites = ['absol', 'accelgor', 'aegislash', 'aegislash-blade', 'aerodactyl', 'aggron', 'alakazam', 'alcremie', 'alomomola', 'ambipom', 'amoonguss', 'ampharos', 'annihilape', 'araquanid', 'arbok', 'arcanine', 'archeops', 'arctovish', 'arctozolt', 'ariados', 'armaldo', 'armarouge', 'aurorus', 'avalugg', 'barraskewda', 'basculegion', 'basculin-bluestriped', 'basculin-redstriped', 'bastiodon', 'beartic', 'beedrill', 'beheeyem', 'bellossom', 'bewear', 'bibarel', 'blastoise', 'blaziken', 'blissey', 'boltund', 'bouffalant', 'braviary', 'breloom', 'bruxish', 'butterfree', 'camerupt', 'carbink', 'carracosta', 'centiskorch', 'ceruledge', 'cetitan', 'chandelure', 'charizard', 'chatot', 'chesnaught', 'chimecho', 'cinderace', 'clawitzer', 'claydol', 'clefable', 'clodsire', 'cloyster', 'cofagrigus', 'comfey', 'conkeldurr', 'copperajah', 'corviknight', 'crabominable', 'cradily', 'cramorant', 'crawdaunt', 'crobat', 'crustle', 'cryogonal', 'dachsbun', 'darmanitan', 'decidueye-hisui', 'decidueye', 'delibird', 'delphox', 'dewgong', 'dhelmise', 'diggersby', 'ditto', 'dondozo', 'donphan', 'donphan-f', 'dracovish', 'dracozolt', 'dragalge', 'dragapult', 'dragonite', 'drifblim', 'dubwool', 'dugtrio-alola', 'dugtrio', 'durant', 'dusknoir', 'eiscue', 'eiscue-noice', 'eldegoss', 'electivire', 'electrode-hisui', 'electrode', 'emboar', 'emolga', 'empoleon', 'escavalier', 'espathra', 'espeon', 'exeggutor', 'exploud', 'falinks', 'farfetchd', 'farigiraf', 'fearow', 'feraligatr', 'ferrothorn', 'flamigo', 'flareon', 'floatzel', 'florges', 'flygon', 'forretress', 'furret', 'gallade', 'galvantula', 'garchomp', 'gardevoir', 'garganacl', 'gastrodon-east', 'gastrodon', 'gengar', 'gholdengo', 'gigalith', 'glaceon', 'glimmora', 'gliscor', 'golduck', 'golem-alola', 'golem', 'golisopod', 'golurk', 'goodra-hisui', 'gorebyss', 'gourgeist', 'grafaiai', 'granbull', 'greninja', 'grimmsnarl', 'gyarados', 'hariyama', 'hatterene', 'heatmor', 'heracross', 'hippowdon', 'hitmonchan', 'hitmonlee', 'hitmontop', 'honchkrow', 'huntail', 'hydreigon', 'illumise', 'incineroar', 'infernape', 'inteleon', 'jellicent', 'jolteon', 'jynx', 'kabutops', 'kangaskhan', 'kecleon', 'kilowattrel', 'kingdra', 'klawf', 'kleavor', 'klefki', 'klinklang', 'komala', 'kommoo', 'kricketune', 'krookodile', 'lanturn', 'lapras', 'leafeon', 'ledian', 'lickilicky', 'liepard', 'lilligant-hisui', 'linoone', 'lopunny', 'lucario', 'ludicolo', 'lumineon', 'lunatone', 'lurantis', 'luvdisc', 'luxray', 'mabosstiff', 'machamp', 'magcargo', 'magmortar', 'magnezone', 'mamoswine', 'mantine', 'maractus', 'marowak-alola', 'marowak', 'masquerain', 'maushold-four', 'mawile', 'meganium', 'meowscarada', 'metagross', 'mightyena', 'milotic', 'miltank', 'mimikyu', 'minun', 'mismagius', 'mr-mime', 'mudsdale', 'muk', 'nidoking', 'nidoqueen', 'ninetales-alola', 'ninetales', 'ninjask', 'noctowl', 'obstagoon', 'octillery', 'oinkologne', 'omastar', 'overqwil', 'pachirisu', 'palafin-hero', 'palafin', 'palossand', 'parasect', 'pelipper', 'perrserker', 'persian-alola', 'persian', 'pidgeot', 'pincurchin', 'pinsir', 'plusle', 'politoed', 'poliwrath', 'porygonz', 'primarina', 'probopass', 'pyukumuku', 'quagsire', 'quaquaval', 'qwilfish', 'raichu-alola', 'raichu', 'rampardos', 'rapidash-galar', 'rapidash', 'raticate-alola', 'raticate', 'relicanth', 'revavroom', 'rhyperior', 'ribombee', 'rillaboom', 'roserade', 'sableye', 'salamence', 'salazzle', 'samurott-hisui', 'samurott', 'sawsbuck-winter', 'sceptile', 'scizor', 'scolipede', 'scrafty', 'seaking', 'serperior', 'sharpedo', 'shedinja', 'shiftry', 'shiinotic', 'shuckle', 'sigilyph', 'sirfetchd', 'skarmory', 'skeledirge', 'slaking', 'slowbro-galar', 'slowbro', 'slowking-galar', 'slowking', 'smeargle', 'sneasler', 'snorlax', 'solrock', 'spinda', 'spiritomb', 'squawkabilly', 'staraptor', 'starmie', 'steelix', 'stonjourner', 'stoutland', 'sudowoodo', 'swampert', 'swanna', 'swellow', 'swoobat', 'sylveon', 'talonflame', 'tangrowth', 'tatsugiri', 'tauros-paldeaaqua', 'tauros-paldeablaze', 'tauros-paldeacombat', 'tauros', 'tentacruel', 'thievul', 'tinkaton', 'torkoal', 'torterra', 'toucannon', 'toxapex', 'trevenant', 'tropius', 'tsareena', 'turtonator', 'typhlosion-hisui', 'typhlosion', 'tyranitar', 'tyrantrum', 'umbreon', 'unfezant', 'ursaluna', 'ursaring', 'vaporeon', 'veluza', 'venomoth', 'venusaur', 'vespiquen', 'victreebel', 'vileplume', 'vivillon', 'volbeat', 'volcarona', 'wailord', 'walrein', 'watchog', 'weavile', 'weezing', 'whimsicott', 'whiscash', 'wigglytuff', 'wobbuffet', 'wugtrio', 'wyrdeer', 'xatu', 'yanmega', 'zoroark-hisui', 'zoroark'];
